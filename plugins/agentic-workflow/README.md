...
**Skills** (invoke when relevant): `design-interview`, `assumption-audit`, `acceptance-stories`, `spike`, `bug-investigation`, `fit-review`, `session-retrospective`, `entropy-pass`.
